...
export const i18n = {
  zh: {
    ...
    emergencyControlSpace: "按空格键：紧急停止所有动作",
    systemDescription: "系统说明",
    systemDescriptionText: "这是一个基于事件驱动架构和原子服务的2D可视化动画系统，展示汽车尾门的复杂动作编排。系统使用物理引擎模拟真实的车辆运动，包括加速、减速和自然减速等效果。通过事件驱动架构，系统能够实时响应各种状态变化和安全事件。",
    features: "功能特性",
  ...
  en: {
    ...
    emergencyControlSpace: "Press Spacebar: Emergency stop all actions",
    systemDescription: "System Description",
    systemDescriptionText: "This is a 2D visualization animation system based on event-driven architecture and atomic services, demonstrating complex action orchestration of vehicle tailgate. The system uses physics engine to simulate real vehicle movement, including acceleration, deceleration and natural deceleration effects. Through event-driven architecture, the system can respond to various state changes and safety events in real-time.",
    features: "Features",
